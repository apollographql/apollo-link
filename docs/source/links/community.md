...
- [apollo-link-computed-porperty](https://github.com/czystyl/apollo-link-computed-property) by [@czystyl](https://github.com/czystyl): @computed directive allows you to create a computed property on the query
